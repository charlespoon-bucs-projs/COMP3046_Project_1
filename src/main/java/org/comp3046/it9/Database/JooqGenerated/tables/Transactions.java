...
public class Transactions extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 859685566;
    ...
    /**
     * The column <code>Transactions.StaffId</code>.
     */
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.<ForeignKey<Record, ?>>asList(Keys.FK_TRANSACTIONS_STAFF_1, Keys.FK_TRANSACTIONS_CUSTOMER_1);
    }
